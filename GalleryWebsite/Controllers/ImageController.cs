    ...
    public class ImageController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Image != null ? 
                          ...
                          Problem("Entity set 'ImageContext.Image'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Location,DateTime,Photographer,tags,Price")] Image image)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Location,DateTime,Photographer,Tags")] Image image)
        {
            if (id != image.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ImageContext.Image'  is null.");
            }
            var image = await _context.Image.FindAsync(id);
            if (image != null)
            {
